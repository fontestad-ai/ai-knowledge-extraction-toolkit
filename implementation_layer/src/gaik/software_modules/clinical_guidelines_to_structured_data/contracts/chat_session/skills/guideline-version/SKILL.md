...
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P28. Produce semver+jurisdiction+effective-date release manifest, predecessor chain, supersession, withdrawal, and TSA-stamped release evidence.
---
...
Produce semver+jurisdiction+effective-date release manifest, predecessor chain, supersession, withdrawal, and TSA-stamped release evidence.
...
```bash
clinical-framework guideline-version --run-id <run_id> --mode verify+build
```
