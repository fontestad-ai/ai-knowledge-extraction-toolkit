---
name: pico-decompose-htn
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P8/P11. Decompose recommendation units into population, intervention, comparator, outcome, eligibility, exclusions, and evidence anchors.
---
...
Decompose recommendation units into population, intervention, comparator, outcome, eligibility, exclusions, and evidence anchors.
...
```bash
clinical-framework pico-decompose-htn --run-id <run_id> --mode verify+build
```
