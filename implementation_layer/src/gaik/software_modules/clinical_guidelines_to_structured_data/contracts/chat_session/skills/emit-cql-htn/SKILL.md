---
name: emit-cql-htn
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P20. Emit CQL Library snapshots from structured recommendation, medication, monitoring, risk, and contraindication artifacts.
---
...
Emit CQL Library snapshots from structured recommendation, medication, monitoring, risk, and contraindication artifacts.
...
```bash
clinical-framework emit-cql-htn --run-id <run_id> --mode verify+build
```
