---
name: extract-bp-thresholds
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P12. Extract blood-pressure threshold bands, SBP/DBP ranges, measurement contexts, crisis routing, and verbatim source anchors.
---

# extract-bp-thresholds
...
Extract blood-pressure threshold bands, SBP/DBP ranges, measurement contexts, crisis routing, and verbatim source anchors.
...
```bash
clinical-framework extract-bp-thresholds --run-id <run_id> --mode verify+build
```
