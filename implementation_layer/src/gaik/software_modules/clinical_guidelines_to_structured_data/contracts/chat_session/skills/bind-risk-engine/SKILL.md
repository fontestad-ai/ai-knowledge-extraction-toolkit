---
name: bind-risk-engine
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P16. Bind ASCVD risk engine semantics to PREVENT canonical calculations and legacy PCE categorical exclusions.
---
...
Bind ASCVD risk engine semantics to PREVENT canonical calculations and legacy PCE categorical exclusions.
...
```bash
clinical-framework bind-risk-engine --run-id <run_id> --mode verify+build
```
