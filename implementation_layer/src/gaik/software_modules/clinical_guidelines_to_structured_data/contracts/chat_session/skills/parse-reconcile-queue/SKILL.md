---
name: parse-reconcile-queue
description: Clinical guideline framework skill generated from the chat-session backlog. Phase reconciliation. Build resolver/verifier queues for disagreements, held outcomes, two-person-rule conflicts, and remediation hints.
---
...
Build resolver/verifier queues for disagreements, held outcomes, two-person-rule conflicts, and remediation hints.
...
```bash
clinical-framework parse-reconcile-queue --run-id <run_id> --mode verify+build
```
