---
name: guideline-docs
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P24/P27. Generate guideline card, NAM CGAT, AGREE II, model card, safety narrative, and implementation-guide narrative docs.
---
...
Generate guideline card, NAM CGAT, AGREE II, model card, safety narrative, and implementation-guide narrative docs.
...
```bash
clinical-framework guideline-docs --run-id <run_id> --mode verify+build
```
