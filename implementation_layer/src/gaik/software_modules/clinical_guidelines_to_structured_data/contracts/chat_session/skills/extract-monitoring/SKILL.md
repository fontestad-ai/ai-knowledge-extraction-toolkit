---
name: extract-monitoring
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P15. Extract monitoring obligations, lab follow-up, BP follow-up, medication monitoring, safety triggers, and pregnancy/pediatric reinforcement.
---
...
Extract monitoring obligations, lab follow-up, BP follow-up, medication monitoring, safety triggers, and pregnancy/pediatric reinforcement.
...
```bash
clinical-framework extract-monitoring --run-id <run_id> --mode verify+build
```
