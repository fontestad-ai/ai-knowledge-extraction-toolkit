---
name: cql-test-synthea-htn
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P21. Run Synthea synthetic cohort tests, branch coverage, hard-block invariant tests, and CDS Hooks regression fixtures.
---

# cql-test-synthea-htn
...
Run Synthea synthetic cohort tests, branch coverage, hard-block invariant tests, and CDS Hooks regression fixtures.
...
```bash
clinical-framework cql-test-synthea-htn --run-id <run_id> --mode verify+build
```
