---
name: bind-htn-vocab
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P10/P17/P18/P19. Bind clinical concepts to RxNorm, SNOMED CT, LOINC, ICD-10-CM, CPT, CVX, UCUM, and OMOP mappings through Ontoserver/HAPI/tx.fhir.org-compatible terminology services.
---
...
Bind clinical concepts to RxNorm, SNOMED CT, LOINC, ICD-10-CM, CPT, CVX, UCUM, and OMOP mappings through Ontoserver/HAPI/tx.fhir.org-compatible terminology services.
...
```bash
clinical-framework bind-htn-vocab --run-id <run_id> --mode verify+build
```
