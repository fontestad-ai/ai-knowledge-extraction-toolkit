---
name: copyright-quote-check-acc-aha
description: Clinical guideline framework skill generated from the chat-session backlog. Phase P4. Enforce ACC/AHA quote envelopes, figure/table restrictions, publisher contract windows, and fair-use ceilings.
---

# copyright-quote-check-acc-aha
...
Enforce ACC/AHA quote envelopes, figure/table restrictions, publisher contract windows, and fair-use ceilings.
...
```bash
clinical-framework copyright-quote-check-acc-aha --run-id <run_id> --mode verify+build
```
