...
Closed model-family classification matrix for dual-agent family-distinct extraction, critic, CQL authoring, and safety review. The framework treats family separation as a safety control, not a style preference.
