...
Provider-aware extraction, critic, reconciliation, CQL drafting, and safety prompts. Reuses robust parser prompt principles and judge calibration rules while enforcing clinical anti-hallucination constraints.
