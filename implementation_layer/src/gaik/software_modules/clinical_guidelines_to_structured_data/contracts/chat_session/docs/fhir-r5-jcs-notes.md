# FHIR R5 JSON Canonicalization Notes
...
Defines the canonical JSON form used before every clinical FHIR resource SHA recompute. It binds RFC 8785 to FHIR R5 exception handling, extension ordering, primitive element siblings, decimal normalization, Coding arrays, Bundle.entry order, Provenance targets, and ImplementationGuide packaging.
